...
const stixCyberObservablesAttributes: { [k: string]: Array<AttributeDefinition> } = {
  ...
  [ENTITY_USER_ACCOUNT]: [
    ...
    { name: 'has_login', label: 'Has login', type: 'boolean', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
    { name: 'has_password', label: 'Has password', type: 'boolean', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: true },
  ],
  [ENTITY_WINDOWS_REGISTRY_KEY]: [
